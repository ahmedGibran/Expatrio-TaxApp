...
void main() {
  ...
  test('should the check of the getTaxData function passed with right return', () async {
  ...
  test('should the check of the getTaxData fail with left return', () async {
    when(mockTaxRepository.getTaxData()).thenAnswer((_) async => const Left(Failure(message: 'fails')));
