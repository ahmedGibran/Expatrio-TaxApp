...
void main() {
  ...
  const TaxResidenceModel taxResidence = TaxResidenceModel(country: "AF", id: "1234567");

  test("fromJson", () async {
    // get data from local json file
    final Map<String, dynamic> mapData = json.decode(fixture("cached_tax_residence_data.json"));
