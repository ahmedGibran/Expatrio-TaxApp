...
class TaxBody extends StatelessWidget {
  ...
  Widget _buildTaxForm(BuildContext context, int formIndex) {
    return Consumer<TaxState>(builder: (context, taxState, _) {
      ...
      String initialTaxIdValue = taxState.taxResidencesMap[index]?.id ?? '';
      return Column(
        ...
        children: <Widget>[
          ...
          InkWell(
            onTap: () {
              _showTaxCountriesBottomSheet(context, index);
            },
            child: Container(
              height: 48,
              width: MediaQuery.of(context).size.width,
          ...
          TextFormField(
            ...
            initialValue: initialTaxIdValue,
            style: const TextStyle(fontSize: 16),
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  autovalidateMode: AutovalidateMode.onUserInteraction,
                  decoration:
                      Constant.kInputDecoration.copyWith(hintText: getTranslatedValue(context, 'search_for_country')),
                ),
              ),
              const SizedBox(height: 16),
              for (int countryIndex = 0; countryIndex < taxState.countryInfos.length; countryIndex++)
                ListTile(
                  onTap: () {
