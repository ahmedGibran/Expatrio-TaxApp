class CountryInfo {
  final String label;
  final String code;
  const CountryInfo(this.label, this.code);
}

class CountriesConstants {
  static List<CountryInfo> get countryInfos => nationalities;

  static final List<CountryInfo> nationalities = [
  ...
  ].map((countryInfo) => CountryInfo(countryInfo['label']!.toString(), countryInfo['code']!.toString())).toList();
}
